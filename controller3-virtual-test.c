...
void Joystick()
{
	...
	leftSpeed = EaseQuad(joystick.joy1_y1)  + EaseCube(joystick.joy1_x1);
	rightSpeed = EaseQuad(joystick.joy1_y1) - EaseCube(joystick.joy1_x1);
